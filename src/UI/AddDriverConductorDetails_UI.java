...
public class AddDriverConductorDetails_UI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 20, 590, -1));
        ...
        panelRound1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 80, -1, -1));
        ...
        panelRound1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 140, -1, -1));
        ...
        panelRound1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 200, -1, -1));

        jLabel12.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(0, 0, 0));
        jLabel12.setText("Email (Optinal)");
        panelRound1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 200, -1, -1));

        jLabel13.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(0, 0, 0));
        jLabel13.setText("Date of Birth");
        panelRound1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 260, -1, -1));

        jLabel14.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(0, 0, 0));
        jLabel14.setText("Work as a");
        panelRound1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 260, -1, -1));

        jTextField1.setBackground(new java.awt.Color(51, 51, 51));
        jTextField1.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jTextField1.setForeground(new java.awt.Color(255, 255, 255));
        panelRound1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 75, 160, -1));

        jTextField2.setBackground(new java.awt.Color(51, 51, 51));
        jTextField2.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jTextField2.setForeground(new java.awt.Color(255, 255, 255));
        panelRound1.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 75, 160, -1));
        ...
        panelRound1.add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 135, 160, -1));

        jTextField4.setBackground(new java.awt.Color(51, 51, 51));
        jTextField4.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jTextField4.setForeground(new java.awt.Color(255, 255, 255));
        panelRound1.add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 255, 160, -1));

        jTextField5.setBackground(new java.awt.Color(51, 51, 51));
        jTextField5.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jTextField5.setForeground(new java.awt.Color(255, 255, 255));
        panelRound1.add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 195, 160, -1));

        jTextField7.setBackground(new java.awt.Color(51, 51, 51));
        jTextField7.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jTextField7.setForeground(new java.awt.Color(255, 255, 255));
        panelRound1.add(jTextField7, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 195, 160, -1));
        ...
        panelRound1.add(Driver, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 255, -1, -1));

        jTextField6.setBackground(new java.awt.Color(51, 51, 51));
        jTextField6.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jTextField6.setForeground(new java.awt.Color(255, 255, 255));
        panelRound1.add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 135, 160, -1));
        ...
        panelRound1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 320, -1, -1));

        jButton1.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jButton1.setForeground(new java.awt.Color(0, 0, 0));
        jButton1.setText("Reset All");
        panelRound1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 330, -1, -1));
        ...
        panelRound1.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 290, 120, 20));

        jPanel3.add(panelRound1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 100, 830, 400));
        ...
        jPanel3.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 530, 100, 35));
